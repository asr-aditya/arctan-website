          ...
          <div className="contact-form3-section-title thq-card">
            ...
            <div className="contact-form3-content2">
              <h2>
                {props.heading1 ?? (
                  <Fragment>
                    <h2 className="contact-form3-text21 thq-heading-2">
                      Contact us
                    </h2>
                  </Fragment>
                )}
...
ContactForm3.defaultProps = {
  ...
  content1: undefined,
  imageSrc:
    'https://images.unsplash.com/photo-1561625116-047f7cc90c13?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzQ1OTE4NXw&ixlib=rb-4.0.3&q=80&w=1080',
  heading1: undefined,
  action: undefined,
}
