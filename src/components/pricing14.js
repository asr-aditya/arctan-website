        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text160 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing14-text204 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text184 thq-heading-3">
                          $99/month
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing14-text190 thq-body-large">
                          Business plan
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text194 thq-heading-3">
                          $49/mo
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text155 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span>
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing14-text193 thq-body-large">
                          Business plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text166 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <span>
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text168 thq-body-large">
                          or $49 monthly
                        </span>
                      </Fragment>
                    )}
