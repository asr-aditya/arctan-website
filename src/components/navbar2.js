      ...
      <header data-thq="thq-navbar" className="navbar2-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links1">
            <a href={props.link2Url} className="navbar2-link21">
              {props.link2 ?? (
                <Fragment>
            ...
            <a href={props.link3Url} className="navbar2-link31">
              {props.link3 ?? (
                <Fragment>
            ...
            <a href={props.link4Url} className="navbar2-link41">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar2-text5 thq-link thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
