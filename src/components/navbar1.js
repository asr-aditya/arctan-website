        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            <a href={props.link1Url}>
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text8 thq-link thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link2Url}>
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text3 thq-link thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link3Url} target="_blank" rel="noreferrer noopener">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar1-text5 thq-link thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
          ...
          <div className="navbar1-buttons1"></div>
        </div>
          ...
          <div className="navbar1-nav">
            ...
            <nav className="navbar1-links2">
              ...
              <a href={props.link4Url}>
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar1-text9 thq-link thq-body-small">
                      Default value
                    </span>
                  </Fragment>
                )}
              ...
              <a href={props.link5Url}>
                {props.link5 ?? (
                  <Fragment>
                    <span className="navbar1-text7 thq-link thq-body-small">
                      Testimonials
                    </span>
                  </Fragment>
                )}
            ...
            <div className="navbar1-buttons2">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar1-text4">Default value</span>
                    </Fragment>
                  )}
                </span>
              </button>
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar1-text6">Default value</span>
                    </Fragment>
                  )}
                </span>
              </button>
